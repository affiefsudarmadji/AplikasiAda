...
class PengaduanController extends Controller
{
    ...
    public function index()
    {
        ...
        $pengaduan = DB::table('pengaduan')
            ...
            ->select('pengaduan.*', 'pengaduan.id', 'users.name AS namausers', 'pengaduan.tgl_pengaduan', 'pengaduan.keterangan', 'pengaduan.status', 'pengaduan.bukti')->get();
    ...
    public function store(Request $request)
    {
        ...
        DB::table('pengaduan')->insert(
            [
                'jenis_gratifikasi' => $request->gratifikasi,
                'hp' => $request->hp,
