...
<head>
  ...
  <title>Register Aplikasi Pelaporan Gratifikasi</title>
  <!-- Font Awesome -->
...
<body>
  ...
  <header>
    ...
    <!-- Full Page Intro -->
    <div class="view"
  style="background-image: url('{{asset('img/hut.jpg')}}'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
        ...
        <div class="container">
          ...
          <div class="row mt-5">
            ...
            <div class="col-md-7 mb-5 mt-md-0 mt-5 white-text text-center text-md-left">
              <h1 class="h1-responsive font-weight-bold wow fadeInLeft" data-wow-delay="0.3s">Aplikasi Pelaporan Gratifikasi</h1>
              <hr class="hr-light wow fadeInLeft" data-wow-delay="0.3s">
              <h6 class="mb-3 wow fadeInLeft" data-wow-delay="0.3s">APASI adalah Aplikasi Sistem Pelaporan Gratifikasi oleh Insan Pegadaian</h6>
                ...
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <div class="card-body">
                    ...
                    <div class="md-form">
                      ...
                      <input type="text" name="email" id="form2"
