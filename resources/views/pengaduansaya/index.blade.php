...
@php
    $judul = ['No','Nama Pelapor','Tanggal Pengaduan','Status','Action'];
@endphp
                  ...
                  <td>
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                          ...
                          <a class="dropdown-item" href="{{url ('laporanpdf') }}" value=""><i class="fas fa-download mr-1"></i>Cetak dan Download</a>
