...
@php
 $nama=\App\Gratifikasi::where('id',$p ->jenis_gratifikasi)->first();
...
<div class="card animated fadeInUp">
    ...
    <form class="text-center" style="color: #757575;" method="POST" action="{{route('pengaduan.update', $p ->id)}}" enctype="multipart/form-data">
        ...
        @csrf
            ...
            <input name="gratifikasi" value="{{$p ->jenis_gratifikasi}}" type="hidden" id="materialSubscriptionFormPasswords" class="form-control" >
            {{-- <input  value="{{$nama ->nama}}" type="text" id="materialSubscriptionFormPasswords" class="form-control" > --}}
                {{-- <label for="materialSubscriptionFormPasswords">Jenis Gratifikasi</label> --}}
            {{-- </div> --}}
