...
@php
$gratifikasi = App\Gratifikasi::all();
@endphp
  ...
  <div class="row">
    <div class="col-md-12 animated fadeInRight">
      <nav aria-label="breadcrumb ">
        <ol class="breadcrumb success-color-dark">
  ...
  <div class="row">
    <div class="col-md-12  animated fadeInUp ">
      ...
      <div class="card card-cascade narrower">
        ...
        <!--Card image-->
        <div
          class="view view-cascade gradient-card-header success-color-dark narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        ...
        <div class="card-body px-lg-5 pt-0">
          ...
          <form role="form" action="{{route('pengaduan.store')}}" method="POST" class="text-center"
            ...
            <select name="gratifikasi" class="mdb-select md-form colorful-select dropdown-danger" required>
              <option value="{{ old('gratifikasi')}}"" disabled selected>Jenis Gratifikasi</option>
              @foreach ($gratifikasi as $d)
              <option value="{{$d ->id}}">{{$d ->nama}}</option>
              @endforeach
            </select>

            <h5 class="card-title">Identitas Pelapor</h5>
            <div class="md-form">
            ...
            <div class="md-form">
              <input type="text" name="namas" id="materialSubscriptionFormEmail" class="form-control">
              <label for="materialSubscriptionFormEmail">Nama Lengkap</label>
            </div>
            ...
            <h5 class="card-title">Keterangan Pelaporan</h5>
