...
<head>
  ...
  <link rel="icon" type="image/png" sizes="16x16" href="{{asset('img/favicon-new.ico')}}">
  <title>Aplikasi Pelaporan Gratifikasi PT Pegadaian (Persero)</title>
  <!-- Font Awesome -->
...
<header>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-7">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item ">
              <a class="nav-link" href="#">Tentang Pelaporan Gratifikasi <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <!-- Navbar -->
    <!-- Full Page Intro -->
    <div class="view jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('img/pegadaian.png'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-12 mb-4 white-text text-center">
              <h2 class="h2-reponsive white-text text-uppercase font-weight-bold mb-0 pt-md-5 pt-5 wow fadeInDown" data-wow-delay="0.3s"><strong>Apa Itu Pelaporan Gratifikasi</strong></h2>
              <hr class="hr-light my-4 wow fadeInDown" data-wow-delay="0.5s">
              <h5 class="h5-reponsive mb-4 white-text wow fadeInDown" data-wow-delay="0.4s"><p>APASI adalah Aplikasi Sistem Pelaporan Gratifikasi oleh Insan Pegadaian
